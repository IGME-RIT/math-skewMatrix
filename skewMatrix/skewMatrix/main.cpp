...
const Matrix2D xAxis = Matrix2D(1, 0, 0, -1);
const Matrix2D yAxis = Matrix2D(-1, 0, 0, 1);
const Matrix2D origin = Matrix2D(-1, 0, 0, -1);
const Matrix2D xy = Matrix2D(0, 1, 1, 0);
...
int main()
{
	...
	std::cout << "Reflection of A along X Axis: " << std::endl;
	std::cout << ReflectMatrix(A, xAxis);

	std::cout << "Reflection of A along Y Axis: " << std::endl;
	std::cout << ReflectMatrix(A, yAxis);

	std::cout << "Reflection of A along origin: " << std::endl;
	std::cout << ReflectMatrix(A, origin);

	std::cout << "Reflection of A along the line x = y: " << std::endl;
	std::cout << ReflectMatrix(A, xy);

	std::cout << std::endl;

	Matrix2D skew = Matrix2D(0, 1, -1, 0);

	if (IsSkewMatrix(skew))
	{
		std::cout << skew << " matrix is a skew matrix!" << std::endl;
	}
	else
	{
		std::cout << skew << " matrix is not a skew matrix!" << std::endl;
	}

	if (IsSkewMatrix(A))
	{
		std::cout << A << " matrix is a skew matrix!" << std::endl;
	}
	else
	{
		std::cout << A << " matrix is not a skew matrix!" << std::endl;
	}
